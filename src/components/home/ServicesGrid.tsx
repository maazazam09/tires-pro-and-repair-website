      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="mb-10 flex items-end justify-between">
          <div>
            ...
            <p className="mt-2 text-metallic">Everything you need to get back on the road — fast.</p>
          </div>
          <Link href="/services" className="hidden items-center gap-1 text-sm font-semibold text-accent hover:underline md:flex">
