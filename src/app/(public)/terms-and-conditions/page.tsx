        ...
        <div className="mx-auto max-w-3xl px-4 text-metallic">
          ...
          <div className="mt-6 space-y-8 text-base leading-relaxed">
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold uppercase text-foreground">Agreement to These Terms</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold uppercase text-foreground">Services</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold uppercase text-foreground">Appointments and Scheduling</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold uppercase text-foreground">Estimates, Pricing, and Availability</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold uppercase text-foreground">Tire, Wheel, and Fitment Responsibility</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold uppercase text-foreground">Used Tires and Customer-Supplied Parts</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold uppercase text-foreground">Authorization and Vehicle Access</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold uppercase text-foreground">Payments and Financing</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold uppercase text-foreground">Warranties and Limitations</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold uppercase text-foreground">Website Content and Third-Party Links</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold uppercase text-foreground">Photos, Reviews, and Feedback</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold uppercase text-foreground">Changes to These Terms</h2>
              <p>
